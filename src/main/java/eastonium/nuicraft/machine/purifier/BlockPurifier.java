...
public class BlockPurifier extends BlockContainer {
	...
	public BlockPurifier(){
        ...
        this.setUnlocalizedName(NuiCraft.MODID + ".purifier");
        this.setRegistryName("purifier");
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ){
		...
		playerIn.openGui(NuiCraft.modInstance, GuiHandlerPurifier.getGuiID(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
	...
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state){
        return new ItemStack(NuiCraftItems.purifier_item);
    }
	
	@Nullable
	@Override
	public Item getItemDropped(IBlockState state, Random rand, int fortune){
        return state.getValue(PART) == BlockBed.EnumPartType.FOOT ? null : NuiCraftItems.purifier_item;
    }
